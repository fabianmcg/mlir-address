...
void AddressDialect::initialize() {
  addOperations<
#define GET_OP_LIST
#include "mlir/Dialect/Address/IR/AddressOps.cpp.inc"
      >();
  registerTypes();
}
...
#include "mlir/Dialect/Address/IR/AddressOpsTypes.cpp.inc"
      >();
}
...
#include "mlir/Dialect/Address/IR/AddressOpsDialect.cpp.inc"
